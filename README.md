...
Systems Engineer building distributed backend systems and decision pipelines for AI and data-driven workflows.

## What I work on
- Event-driven backend systems on AWS (Lambda, SQS)
- Evaluation and ranking systems for model and system selection
...
- **Agent Orchestration & Evaluation Framework**  
  Built to explore how agent workflows can be executed and evaluated consistently rather than treated as one-off runs  

- **Multi-Tenant AI Platform**  
  RAG-based system with authentication and modular orchestration layers  

- **RAG Analytics System**  
  Reworked an existing analytics system into a more structured pipeline with AI integration in mind  

## Approach
I tend to focus on systems where:
- decisions need to be made under constraints (not just outputs generated)
- behaviour needs to be consistent and explainable
